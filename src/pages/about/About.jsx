...
const About = () => {
  return (
    <div className="mb-12 lg:mb-0">
      ...
      <div className="lg:flex lg:items-start lg:gap-8 bg-bgColor bg-opacity-50 p-2 rounded-lg mt-10 ">
        <div className=" space-y-4">
          ...
          <p>
            Uso herramientas como <strong>VS Code</strong>, <strong>Git</strong> y <strong>GitHub</strong> para el control de versiones, y <strong>Node.js</strong> como entorno para gestionar mis proyectos y dependencias. Además, estoy especializado en <strong>HTML</strong>, <strong>CSS</strong>, <strong>JavaScript</strong>, <strong>React</strong>, <strong>Tailwind</strong> y <strong>Vitest</strong> para hacer test unitarios.
          </p>
          <p>
          ...
          <p>
            Desde hace más de un año, he estado desarrollando proyectos personales sin parar, enfocándome siempre en la mejora y el aprendizaje. Gracias a esto, a día de hoy me siento más que preparado para dar el paso al mundo profesional como desarrollador frontend. Estoy convencido de que puedo aportar valor tanto a nivel técnico como humano, trabajando en equipo y contribuyendo al crecimiento de los proyectos en los que participe.
          </p>
        </div>
        <div className="">
